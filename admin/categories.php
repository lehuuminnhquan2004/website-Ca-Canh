...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['order_ids'])) {
    ...
    $config['categories_order'] = array_values(array_unique($ids));
    file_put_contents(
        $configPath,
...
$orderList = $config['categories_order'] ?? [];
if (!empty($orderList)) {
...
<div class="container">
  ...
  <?php if ($orderSaved): ?>
    <p style="color:green;">Đã lưu thứ tự danh mục.</p>
  <?php endif; ?>
