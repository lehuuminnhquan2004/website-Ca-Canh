...
<script>
(() => {
  const box = document.querySelector('.sanphammoi .product-grid');
  const prevBtn = document.querySelector('.sanphammoi .nav-arrow.prev');
  const nextBtn = document.querySelector('.sanphammoi .nav-arrow.next');
