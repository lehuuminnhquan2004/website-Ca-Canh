<?php
$page_title = "Phụ kiện - Cá cảnh Q8 Aquarium Coffee";
$page_description = "Danh sách phụ kiện hồ cá, vật liệu lọc, đèn, máy oxy và trang trí hồ cá tại Cá cảnh Quận 8 Aquarium Coffee.";
...
$page_description = $selectedCategoryName
    ? "Phụ kiện hồ cá - Danh mục {$selectedCategoryName} tại Q8 Aquarium Coffee."
    : $page_description;
